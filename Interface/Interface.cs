...
// Архитектура ПО.Принципы проектирования классов S.O.L.I.D.-20221121_190024-Запись собрания 01:50:25 - аналогичный пример на с++
...
internal class Interface
{
    ...
    {
        var someInfoGenerator = new SomeInfoGenerator();
