...
namespace SomeInfoGeneratorNameSpace
{
    public class SomeInfoGenerator
    {
        ...
        private List<double> dvdWriteSpeedList = new List<double>()
        {
        ...
        public void FillUpDVD(ref DVD dvd) // todo: возможно не с нуля, а с 1 нужно рандомно выбирать.
        {
            Random random = new Random();
        ...
        private List<string> flashManufacturerList = new List<string>()
        {
        ...
        private List<string> flashModelList = new List<string>()
        {
        ...
        private List<int> flashCapacityList = new List<int>()
        {
            // Емкость флеш-накопителей в Гб.
            1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072, 262144, 524288
        };

        private List<double> flashSpeedList = new List<double>()
        {
        ...
        public void FillUpFlash(ref Flash flash) // todo: возможно не с нуля, а с 1 нужно рандомно выбирать.
        {
            Random random = new Random();
        ...
        private List<string> hddManufacturerList = new List<string>()
        {
        ...
        private List<string> hddModelList = new List<string>()
        {
            // Модели жестких дисков разных производителей.
            "HDD1", "HDD2", "HDD3", "HDD4", "HDD5", "HDD6", "HDD7", "HDD8", "HDD9", "HDD10", "HDD11", "HDD12", "HDD13"
        };

        private List<double> hddCapacityList = new List<double>()
        {
            // Емкость жестких дисков в Гб.
            1, 2, 4, 8, 16, 32, 64, 128, 256, 512, 1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072, 262144, 524288
        };

        private List<double> hddSpindleSpeedList = new List<double>()
        {
        ...
        public void FillUpHDD(ref HDD hdd) // todo: возможно не с нуля, а с 1 нужно рандомно выбирать.
        {
            Random random = new Random();
